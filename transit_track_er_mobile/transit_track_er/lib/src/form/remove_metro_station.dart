...
Future<void> showRemoveFavoriteStationDialog(BuildContext context, Box<FavoriteStation> box, MetroStation station) async {
  ...
  final bool? continueAction = await showDialog<bool>(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text('Do you want to set a custom alarm date and time?'),
        actions: [
          TextButton(
